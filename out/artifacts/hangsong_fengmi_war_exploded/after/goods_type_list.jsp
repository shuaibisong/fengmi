...
<a href="<%=path%>/after/add_goods_type.jsp?num=1">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
        ...
        <table style="text-align: center;margin-right:10px;width:99%"
            ...
            <c:forEach items="${list}" var="goodsType" varStatus="obj">
                ...
                <tr>
                    ...
                    <td><a href="<%=path%>/after/add_goods_type.jsp?id=${goodsType.id}&num=0" onclick="if(confirm('是否确定编辑'+'${user.username}'+'？')==false)return false">
